...
export default function Sidebar({ questions, currentQuestionIndex }) {
  return (
    <div className="d-flex flex-column flex-grow-1">
      ...
      <div className="d-flex justify-content-around">
        <button className="bordered-container perk fifty btn">
          <div className="diagonal-line"></div>
        </button>
        <button className="bordered-container perk google btn">
